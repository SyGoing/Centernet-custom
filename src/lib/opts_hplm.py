...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', type=str, default='multi_pose',
                             help='ctfacedet | ctdet | ctfacedetlm |ddd | multi_pose | exdet ')
    self.parser.add_argument('--dataset', default='coco_facedet_hplm',type=str,
    ...
    self.parser.add_argument('--kpts_weight', type=float, default=0.1,
                             help='loss weight for five keypoints.')
    self.parser.add_argument('--kptreg', type=bool, default=False,
                             help='loss weight for bounding box size.')
