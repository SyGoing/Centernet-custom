...
class CTDetFaceVOCDataset(data.Dataset):
    num_classes = 1
    ...
    def __init__(self, opt, split,add_lm=False):
        super(CTDetFaceVOCDataset, self).__init__()
        ...
        self.images = CTDetFaceVOCDataset._read_image_ids(image_sets_file)
